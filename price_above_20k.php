<?php
// price_above_20k.php - Records with price greater than 20,000
session_start();
...
try {
    ...
    echo "<div style='display:flex;align-items:center;justify-content:space-between;margin-bottom:20px'>
            <div>
              <div class='page-title'>&#128142; Phones Priced Above PKR 20,000</div>
              <div class='page-sub'>Premium phones sorted by price</div>
            </div>
          </div>";
    ...
    if ($totalCheck == 0) {
        ...
        echo "<div style='text-align:center;padding:60px 24px;'>
                <div style='width:72px;height:72px;border-radius:20px;background:#f5f3ff;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;'>
                  <svg width='34' height='34' viewBox='0 0 24 24' fill='none' stroke='#7c3aed' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'><rect x='7' y='2' width='10' height='20' rx='2'/><line x1='7' y1='6' x2='17' y2='6'/><line x1='7' y1='18' x2='17' y2='18'/></svg>
                </div>
        ...
        $stmt = $conn->prepare("SELECT * FROM mobile_phone WHERE price > 20000 ORDER BY price ASC");
        ...
        if ($cnt === 0) {
            echo "<div style='text-align:center;padding:50px 24px;'>
                    <div style='width:64px;height:64px;border-radius:18px;background:#f5f3ff;display:flex;align-items:center;justify-content:center;margin:0 auto 14px;'>
                      <svg width='28' height='28' viewBox='0 0 24 24' fill='none' stroke='#7c3aed' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'><circle cx='12' cy='12' r='10'/><line x1='12' y1='8' x2='12' y2='12'/><line x1='12' y1='16' x2='12.01' y2='16'/></svg>
                    </div>
                    <div style='font-size:17px;font-weight:700;color:#0f172a;margin-bottom:6px;'>No Premium Phones Found</div>
                    <div style='font-size:13.5px;color:#64748b;margin-bottom:20px;'>None of your phones are priced above PKR 20,000.</div>
